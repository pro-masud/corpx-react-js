                    ...
                    <div className="row gy-5 gx-64 d-flex align-items-center">
                        <div className="col-xl-6 col-lg-6">
                            <div className="wcu-thumb">
                                <div className="thumb1 bg-cover"><img src={UCUFeatureImage} alt="thumb" className="wow img-custom-anim-left" /></div>
                            ...
                            <div className="wcu-content">
                                ...
                                <div className="check-list-items">
                                    <ul className="checklist wow fadeInUp" data-wow-delay="0.3s">
                                     ...
                                     <div style={{ width: 100, height: 100 }} className="single-circle-bar wow fadeInUp" data-wow-delay=".3s">
