    ...
    <>
        <section className="hero-section hero-2">
            <div className="container-fluid">
                <div className="expert-image wow img-custom-anim-left">
                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="hero-content">
                            ...
                            <div className="client-img wow fadeInUp" data-wow-delay=".3s">
                ...
                <div className="social-list wow fadeInUp" data-wow-delay=".3s">
                ...
                <Link href="about.html" className="video-btn video-popup">
